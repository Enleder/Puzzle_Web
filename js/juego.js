...
var instrucciones = ["Utiliza las flechas para mover las piezas", "Ordena las piezas con el fin de alcanzar la imagen objetivo"];
...
function mostrarInstrucciones(instrucciones)
{
    ...
    for (var i = 0; i < instrucciones.length; i++)
    {
        ...
        console.log("Mostrando instrucciones en forma de lista");
    }
}

/* COMPLETAR: Crear función que agregue la última dirección al arreglo de movimientos
y utilice actualizarUltimoMovimiento para mostrarlo en pantalla */
function cargarMovimientosEnArreglo(direccion)
{
    movimientos.push(direccion);
    actualizarUltimoMovimiento(direccion);
    console.log("Se carga movimiento en arreglo", direccion);
}
...
function chequearSiGano()
{
    ...
    while((gano == true) && (i < grilla.length) && (j < grilla[i].length));
...
function mostrarCartelGanador()
{
    ...
    {
        console.log("Se muestra mensaje ganador");
        alert("¡BIEN DESAFIO COMPLETADO!");
    }
}
...
{
    //COMPLETAR
    var aux1 =  grilla[filaPos1][columnaPos1];
    console.log("variable auxiliar 1 =" + aux1);

    grilla[filaPos1][columnaPos1] =  grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = aux1;
...
function posicionValida(fila, columna)
{
    ...
    {
        return true;
        console.log("Posicion valida: true");
    }
    else
    {
        return false;
        console.log("Posicion valida: false");
    }
}
...
function moverEnDireccion(direccion)
{
    ...
    if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia))
    {
        ...
        cargarMovimientosEnArreglo(direccion);
    }
}
